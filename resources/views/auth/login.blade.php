...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card" style="top: 43%; padding: 37px 0px 37px 0px;">
                <p class="text-center">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="text" class="form-control @error('user_name') is-invalid @enderror" name="user_name" value="{{ old('user_name') }}" required autocomplete="email" placeholder="ইউজারনেম" autofocus>
