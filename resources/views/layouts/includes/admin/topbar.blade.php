                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            ...
                            <span class="user-profile">{{ (Auth::user()->type == 1)?"Admin":"User" }}</span>
                        </div>
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                ...
                                <li> <a href="pages_lock-screen.html"><i class="fa fa-lock" aria-hidden="true"></i> Change Password</a></li>
                                <li><a href="{{ route('logout')}}"><i class="fa fa-cog" aria-hidden="true"></i> Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
